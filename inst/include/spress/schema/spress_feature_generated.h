...
#ifndef FLATBUFFERS_GENERATED_SPRESSFEATURE_SPRESS_IO_H_
#define FLATBUFFERS_GENERATED_SPRESSFEATURE_SPRESS_IO_H_

#include "flatbuffers/flatbuffers.h"

#include "spress_header_generated.h"
...
struct Geometry FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<double> *index() const {
    return GetPointer<const flatbuffers::Vector<double> *>(VT_INDEX);
  }
  ...
  spress::io::GeometryType type() const {
    return static_cast<spress::io::GeometryType>(GetField<uint8_t>(VT_TYPE, 0));
  }
  const flatbuffers::Vector<flatbuffers::Offset<spress::io::Geometry>> *parts() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<spress::io::Geometry>> *>(VT_PARTS);
  }
...
struct GeometryBuilder {
  ...
  void add_index(flatbuffers::Offset<flatbuffers::Vector<double>> index) {
    fbb_.AddOffset(Geometry::VT_INDEX, index);
  }
  ...
  void add_type(spress::io::GeometryType type) {
    fbb_.AddElement<uint8_t>(Geometry::VT_TYPE, static_cast<uint8_t>(type), 0);
  }
  void add_parts(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<spress::io::Geometry>>> parts) {
...
inline flatbuffers::Offset<Geometry> CreateGeometry(
    ...
    flatbuffers::Offset<flatbuffers::Vector<double>> index = 0,
    ...
    spress::io::GeometryType type = spress::io::GeometryType_Unknown,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<spress::io::Geometry>>> parts = 0) {
...
inline flatbuffers::Offset<Geometry> CreateGeometryDirect(
    ...
    const std::vector<double> *index = nullptr,
    ...
    spress::io::GeometryType type = spress::io::GeometryType_Unknown,
    const std::vector<flatbuffers::Offset<spress::io::Geometry>> *parts = nullptr) {
  auto ends__ = ends ? _fbb.CreateVector<uint32_t>(*ends) : 0;
  auto index__ = index ? _fbb.CreateVector<double>(*index) : 0;
  ...
  auto parts__ = parts ? _fbb.CreateVector<flatbuffers::Offset<spress::io::Geometry>>(*parts) : 0;
  return spress::io::CreateGeometry(
      _fbb,
      ends__,
      index__,
      z__,
...
struct Feature FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const spress::io::Geometry *geometry() const {
    return GetPointer<const spress::io::Geometry *>(VT_GEOMETRY);
  }
  const flatbuffers::Vector<uint8_t> *properties() const {
    return GetPointer<const flatbuffers::Vector<uint8_t> *>(VT_PROPERTIES);
  }
  const flatbuffers::Vector<flatbuffers::Offset<spress::io::Column>> *columns() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<spress::io::Column>> *>(VT_COLUMNS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct FeatureBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_geometry(flatbuffers::Offset<spress::io::Geometry> geometry) {
  ...
  void add_columns(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<spress::io::Column>>> columns) {
...
inline flatbuffers::Offset<Feature> CreateFeature(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<spress::io::Geometry> geometry = 0,
    flatbuffers::Offset<flatbuffers::Vector<uint8_t>> properties = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<spress::io::Column>>> columns = 0) {
...
inline flatbuffers::Offset<Feature> CreateFeatureDirect(
    ...
    const std::vector<flatbuffers::Offset<spress::io::Column>> *columns = nullptr) {
  auto properties__ = properties ? _fbb.CreateVector<uint8_t>(*properties) : 0;
  auto columns__ = columns ? _fbb.CreateVector<flatbuffers::Offset<spress::io::Column>>(*columns) : 0;
  return spress::io::CreateFeature(
      _fbb,
      geometry,
      properties__,
      columns__);
...
inline const spress::io::Feature *GetFeature(const void *buf) {
  return flatbuffers::GetRoot<spress::io::Feature>(buf);
}

inline const spress::io::Feature *GetSizePrefixedFeature(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<spress::io::Feature>(buf);
}

inline bool VerifyFeatureBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<spress::io::Feature>(nullptr);
}

inline bool VerifySizePrefixedFeatureBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<spress::io::Feature>(nullptr);
}

inline void FinishFeatureBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<spress::io::Feature> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_SPRESSFEATURE_SPRESS_IO_H_
