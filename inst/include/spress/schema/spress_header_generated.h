...
#ifndef FLATBUFFERS_GENERATED_SPRESSHEADER_SPRESS_IO_H_
#define FLATBUFFERS_GENERATED_SPRESSHEADER_SPRESS_IO_H_
...
struct Column FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  spress::io::ColumnType type() const {
    return static_cast<spress::io::ColumnType>(GetField<uint8_t>(VT_TYPE, 0));
  }
...
struct ColumnBuilder {
  ...
  void add_type(spress::io::ColumnType type) {
...
inline flatbuffers::Offset<Column> CreateColumn(
    ...
    spress::io::ColumnType type = spress::io::ColumnType_Byte,
...
struct Header FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<double> *extent() const {
    return GetPointer<const flatbuffers::Vector<double> *>(VT_EXTENT);
  }
  spress::io::GeometryType geometry_type() const {
    return static_cast<spress::io::GeometryType>(GetField<uint8_t>(VT_GEOMETRY_TYPE, 0));
  }
  bool has_z() const {
  ...
  const spress::io::Crs *crs() const {
    return GetPointer<const spress::io::Crs *>(VT_CRS);
  }
  const flatbuffers::String *title() const {
    return GetPointer<const flatbuffers::String *>(VT_TITLE);
  }
...
struct HeaderBuilder {
  ...
  void add_extent(flatbuffers::Offset<flatbuffers::Vector<double>> extent) {
    fbb_.AddOffset(Header::VT_EXTENT, extent);
  }
  void add_geometry_type(spress::io::GeometryType geometry_type) {
  ...
  void add_crs(flatbuffers::Offset<spress::io::Crs> crs) {
...
inline flatbuffers::Offset<Header> CreateHeader(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::String> name = 0,
    flatbuffers::Offset<flatbuffers::Vector<double>> extent = 0,
    spress::io::GeometryType geometry_type = spress::io::GeometryType_Unknown,
    bool has_z = false,
    bool has_m = false,
    bool has_t = false,
    bool has_tm = false,
    ...
    flatbuffers::Offset<spress::io::Crs> crs = 0,
    flatbuffers::Offset<flatbuffers::String> title = 0,
    flatbuffers::Offset<flatbuffers::String> description = 0,
    flatbuffers::Offset<flatbuffers::String> metadata = 0) {
...
inline flatbuffers::Offset<Header> CreateHeaderDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const char *name = nullptr,
    const std::vector<double> *extent = nullptr,
    spress::io::GeometryType geometry_type = spress::io::GeometryType_Unknown,
    bool has_z = false,
    bool has_m = false,
    bool has_t = false,
...
inline const spress::io::Header *GetHeader(const void *buf) {
  return flatbuffers::GetRoot<spress::io::Header>(buf);
}

inline const spress::io::Header *GetSizePrefixedHeader(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<spress::io::Header>(buf);
}

inline bool VerifyHeaderBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<spress::io::Header>(nullptr);
}

inline bool VerifySizePrefixedHeaderBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<spress::io::Header>(nullptr);
}

inline void FinishHeaderBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<spress::io::Header> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_SPRESSHEADER_SPRESS_IO_H_
